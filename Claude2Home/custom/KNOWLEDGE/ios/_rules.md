...
6. For crash, hang or stackshot artifacts use `~/.claude/custom/KNOWLEDGE/swift/debugging/`; classify with `~/.claude/custom/KNOWLEDGE/swift/debugging/crash-triage.md` before naming a cause.
