...
Every substantial run ends with the final `TRACE` block (template in the injected RESOLVER.md; fallback: `~/.claude/custom/_core/skill-context.md`), reporting references read, knowledge read, patterns or policies applied, verification and residual risk.
