...
4. Preserve workflow-first architecture: `CORE.md`, `RESOLVER.md`, registered active workflow skills and lazy `KNOWLEDGE/`.
...
- Do not add a top-level skill when a mode or `KNOWLEDGE/<domain>/` pack is enough unless the user explicitly requests a skill folder and routing.
