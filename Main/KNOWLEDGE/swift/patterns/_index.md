...
Canonical pattern guidance lives in `KNOWLEDGE/swift/patterns/`.
...
2. Read only the matching `KNOWLEDGE/swift/patterns/<category>/` file after a signal appears.
