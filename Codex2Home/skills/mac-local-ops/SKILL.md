...
Skill root: `$CODEX_HOME/skills/mac-local-ops/`. Reference paths such as `references/...`, `modes/...`,
...
For shell tasks, show whether `$CODEX_HOME/custom/KNOWLEDGE/shell/_rules.md` was loaded.
...
2. Read `$CODEX_HOME/custom/_core/destructive-actions-policy.md`.
3. Load `$CODEX_HOME/custom/KNOWLEDGE/shell/_rules.md` when shell, zsh, mise or brew behavior matters.
...
- `$CODEX_HOME/custom/_core/destructive-actions-policy.md` - confirmation gate.
