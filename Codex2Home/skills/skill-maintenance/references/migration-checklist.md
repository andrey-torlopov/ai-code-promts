...
1. New canonical route exists in `$CODEX_HOME/custom/RESOLVER.md`.
2. Useful workflow rules moved to an active workflow skill.
3. Domain-specific rules moved to `$CODEX_HOME/custom/KNOWLEDGE/`.
4. Runtime anchors point to `$CODEX_HOME/custom/CORE.md` and `$CODEX_HOME/custom/RESOLVER.md`.
