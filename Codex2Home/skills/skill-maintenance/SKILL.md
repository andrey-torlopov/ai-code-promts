...
Skill root: `$CODEX_HOME/skills/skill-maintenance/`. Reference paths such as `references/...`, `modes/...`,
...
4. Preserve workflow-first architecture: `$CODEX_HOME/custom/CORE.md`, `$CODEX_HOME/custom/RESOLVER.md`, registered active workflow skills and lazy `$CODEX_HOME/custom/KNOWLEDGE/`.
...
- Do not add a top-level skill when a mode or `$CODEX_HOME/custom/KNOWLEDGE/<domain>/` pack is enough unless the user explicitly requests a skill folder and routing.
