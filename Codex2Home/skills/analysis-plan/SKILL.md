...
Skill root: `$CODEX_HOME/skills/analysis-plan/`. Reference paths such as `references/...`, `modes/...`,
...
4. Load only the minimum `$CODEX_HOME/custom/KNOWLEDGE/` packs selected by the mode and scope.
