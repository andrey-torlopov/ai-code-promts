...
6. For crash, hang or stackshot artifacts use `$CODEX_HOME/custom/KNOWLEDGE/swift/debugging/`; classify with `$CODEX_HOME/custom/KNOWLEDGE/swift/debugging/crash-triage.md` before naming a cause.
